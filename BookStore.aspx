...
<body>
    <div class="center">
        ...
        <p style="width:600px">
            You can selet a book from the dropdown list to see the book's description. Click the Checkout button to check out the selected book. 
            You can checkout maximum <asp:Label runat="server" ID="lblMaxCheckout" Font-Bold="true" ForeColor="Red"></asp:Label> books</p>
